...
def scrape_pages():
    # for i in range(1, 10): # This will give 400 items for the above 
    for i in range(1, 3):
        page_url = f"https://www.jumia.co.ke/home-office-appliances/?rating=3-5&shipped_from=jumia_global&page={i}#catalog-listing"
...
def add_data(mobile_article):
    ...
    category.append("Home Appliances")
