...
page_url = f"https://www.jumia.co.ke/smartphones/?sort=rating&tag=JMALL&page={i}#catalog-listing"
...
def scrape_pages():
    # for i in range(1, 6): # This will give 400 items for the above 
    for i in range(1, 3):
        page_url = f"https://www.jumia.co.ke/smartphones/?sort=rating&tag=JMALL&page={i}#catalog-listing"
